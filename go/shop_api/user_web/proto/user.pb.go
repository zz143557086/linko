...
type PasswordCheckInfo struct {
	...
	Password string `protobuf:"bytes,2,opt,name=password,proto3" json:"password,omitempty"` // 字符串类型字段，用于存储密码// 字符串类型字段，用于存储加密后的密码
}
...
func (x *PasswordCheckInfo) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
type CheckResponse struct {
	...
	Success bool `protobuf:"varint,1,opt,name=success,proto3" json:"success,omitempty"` // 布尔类型字段，用于表示检查是否成功
}
...
type PageInfo struct {
	...
	Pn    uint32 `protobuf:"varint,1,opt,name=pn,proto3" json:"pn,omitempty"`       // 无符号32位整数类型字段，用于表示页码
	PSize uint32 `protobuf:"varint,2,opt,name=pSize,proto3" json:"pSize,omitempty"` // 无符号32位整数类型字段，用于表示每页的大小
}
...
type MobileRequest struct {
	...
	Mobile string `protobuf:"bytes,1,opt,name=mobile,proto3" json:"mobile,omitempty"` // 字符串类型字段，用于存储手机号
}
...
type IdRequest struct {
	...
	Id int32 `protobuf:"varint,1,opt,name=id,proto3" json:"id,omitempty"` // 有符号32位整数类型字段，用于存储ID
}
...
type CreateUserInfo struct {
	...
	Name     string `protobuf:"bytes,1,opt,name=Name,proto3" json:"Name,omitempty"`         // 字符串类型字段，用于存储昵称
	PassWord string `protobuf:"bytes,2,opt,name=passWord,proto3" json:"passWord,omitempty"` // 字符串类型字段，用于存储密码
	Mobile   string `protobuf:"bytes,3,opt,name=mobile,proto3" json:"mobile,omitempty"`     // 字符串类型字段，用于存储手机号
}
...
type UpdateUserInfo struct {
	...
	Id       int32  `protobuf:"varint,1,opt,name=id,proto3" json:"id,omitempty"`             // 有符号32位整数类型字段，用于存储ID
	Name     string `protobuf:"bytes,2,opt,name=Name,proto3" json:"Name,omitempty"`          // 字符串类型字段，用于存储昵称
	Gender   string `protobuf:"bytes,3,opt,name=gender,proto3" json:"gender,omitempty"`      // 字符串类型字段，用于存储性别
	BirthDay uint64 `protobuf:"varint,4,opt,name=birthDay,proto3" json:"birthDay,omitempty"` // 无符号64位整数类型字段，用于存储生日
}
...
type UserInfoResponse struct {
	...
	PassWord string `protobuf:"bytes,2,opt,name=passWord,proto3" json:"passWord,omitempty"`  // 字符串类型字段，用于存储密码
	Mobile   string `protobuf:"bytes,3,opt,name=mobile,proto3" json:"mobile,omitempty"`      // 字符串类型字段，用于存储手机号
	Name     string `protobuf:"bytes,4,opt,name=Name,proto3" json:"Name,omitempty"`          // 字符串类型字段，用于存储昵称
	BirthDay uint64 `protobuf:"varint,5,opt,name=birthDay,proto3" json:"birthDay,omitempty"` // 无符号64位整数类型字段，用于存储生日
	Gender   string `protobuf:"bytes,6,opt,name=gender,proto3" json:"gender,omitempty"`      // 字符串类型字段，用于存储性别
	Role     int32  `protobuf:"varint,7,opt,name=role,proto3" json:"role,omitempty"`         // 有符号32位整数类型字段，用于存储角色信息
}
...
type UserListResponse struct {
	...
	Total int32               `protobuf:"varint,1,opt,name=total,proto3" json:"total,omitempty"` // 有符号32位整数类型字段，用于存储总数
	Data  []*UserInfoResponse `protobuf:"bytes,2,rep,name=data,proto3" json:"data,omitempty"`    // 重复的UserInfoResponse类型字段，用于存储用户信息列表
}
...
var file_user_proto_rawDesc = []byte{
	...
	0x70, 0x74, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x43, 0x0a, 0x11, 0x50, 0x61, 0x73,
	0x73, 0x77, 0x6f, 0x72, 0x64, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x12,
	...
	0x64, 0x22, 0x58, 0x0a, 0x0e, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x55, 0x73, 0x65, 0x72, 0x49,
	0x6e, 0x66, 0x6f, 0x12, 0x12, 0x0a, 0x04, 0x4e, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x04, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x1a, 0x0a, 0x08, 0x70, 0x61, 0x73, 0x73, 0x57,
	...
	0x01, 0x28, 0x09, 0x52, 0x06, 0x6d, 0x6f, 0x62, 0x69, 0x6c, 0x65, 0x22, 0x68, 0x0a, 0x0e, 0x55,
	...
	0x74, 0x68, 0x44, 0x61, 0x79, 0x22, 0xb2, 0x01, 0x0a, 0x10, 0x55, 0x73, 0x65, 0x72, 0x49, 0x6e,
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x32, 0xb5, 0x02, 0x0a, 0x04,
