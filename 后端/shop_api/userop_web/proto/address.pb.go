...
func (*UnimplementedAddressServer) DeleteAddress(context.Context, *AddressRequest) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DeleteAddress not implemented")
}
func (*UnimplementedAddressServer) UpdateAddress(context.Context, *AddressRequest) (*empty.Empty, error) {
